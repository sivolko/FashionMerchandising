<%@ Page Language="C#" AutoEventWireup="true" Codefile="fashion15.aspx.cs" Inherits="fashion15" %>
    ...
    <div>
        <asp:Panel ID="Panel1" runat="server" Height="352px" Style="z-index: 100; left: 8px;
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" Style="z-index: 102; left: 352px;
                position: absolute; top: 192px" Width="136px" BackColor="#FFC0C0">BUISSNESS PLAN</asp:LinkButton>
            &nbsp;&nbsp;<br />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            &nbsp;
            <asp:Panel ID="Panel3" runat="server" Height="280px" Style="z-index: 104; left: 8px;
                position: absolute; top: 72px" Width="208px">
                <img src="pictures/men/chil/431-318-X43ss.jpg" style="z-index: 100; left: 0px; width: 224px;
                    position: absolute; top: 0px; height: 280px" alt ="a" />
            </asp:Panel>
        </asp:Panel>
